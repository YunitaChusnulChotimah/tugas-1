...
<html lang="en">
<head>
  <title><?php echo "Hebat Hotel - ".$nama; ?></title>
  <meta charset="utf-8">
...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>Jember Jawa Timur, AZ 85004, INA</div>
                        <div>(123) 456-789</div>
                        <div>hebathotel@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
            ...
            <footer>
                Bukti pemesanan kamar Hotel Hebat Jember - Jawa Timur - Indonesia.
            </footer>
        </div>
